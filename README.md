...
1. the project was last touched two years ago
2. the install script uses Centos 7 as the base
3. I believe the project was last ran using python2 which is now deprecated.
